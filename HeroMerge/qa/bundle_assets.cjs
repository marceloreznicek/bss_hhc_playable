...
const HTML    = path.resolve(__dirname, '..', 'HeroMerge_playable_v0.1.html');
...
const SPRITE_MAP = {
  ...
  ogre:        ['lenhador.png',     'image/png', HSASSET],  // T2
  knight:      ['heroicagadi.png',  'image/png', HSASSET],  // T3 — was igris.png
  goblin:      ['babyorc.png',      'image/png', HSASSET],
  brute:       ['juggermon2.png',   'image/png', HSASSET],  // L1 enemy boss — restored
  champion:    ['igris.png',        'image/png', HSASSET],  // T4 — former T3 hero promoted
